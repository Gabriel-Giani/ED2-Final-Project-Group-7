    ...
    <div className="flex items-center gap-1 group relative">
      {[...Array(fullSymbols)].map((_, i) => (
        <svg key={`full-${i}`} className="w-4 h-4" viewBox="0 0 24 24" fill="none">
          <circle cx="12" cy="12" r="9" stroke="#ef4444" strokeWidth="3" fill="none" />
          <line x1="5" y1="19" x2="19" y2="5" stroke="#ef4444" strokeWidth="3" />
        </svg>
      ))}
      {hasHalfSymbol && (
      ...
      <div className="flex flex-col">
        ...
        >
          <h3 className="text-white text-sm font-semibold flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-risk-high">
