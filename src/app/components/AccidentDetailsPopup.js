            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Coordinates: {accident.latitude?.toFixed(6) || "N/A"}, {accident.longitude?.toFixed(6) || "N/A"}
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {formatTime(accident.crashtime)} ({getDayOfWeekText(accident.dayofweek)})
                </p>
              </div>
              ...
              <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="mt-1 grid grid-cols-2 gap-2 text-sm">
                  <div>
                    ...
                    <span className="text-gray-900 dark:text-white">{accident.cntofinj || "0"}</span>
                  </div>
                  <div>
                    <span className="text-gray-500 dark:text-gray-400">Fatalities: </span>
                    <span className="text-gray-900 dark:text-white">{accident.cntoffatl || "0"}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="mt-1 grid grid-cols-2 gap-2 text-sm">
                  <div>
                    ...
                    <span className="text-gray-900 dark:text-white">{getWeatherText(accident.weathcond)}</span>
                  </div>
                  <div>
                    <span className="text-gray-500 dark:text-gray-400">Light: </span>
                    <span className="text-gray-900 dark:text-white">{getLightConditionText(accident.lightcond)}</span>
                  </div>
                  <div>
                    <span className="text-gray-500 dark:text-gray-400">Road Surface: </span>
                    <span className="text-gray-900 dark:text-white">{getRoadSurfaceText(accident.rdsurfcond)}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="mt-1 grid grid-cols-3 gap-2 text-sm">
                  <div>
                    ...
                    <span className="text-gray-900 dark:text-white">{accident.cntofveh || "0"}</span>
                  </div>
                  <div>
                    <span className="text-gray-500 dark:text-gray-400">Pedestrians: </span>
                    <span className="text-gray-900 dark:text-white">{accident.cntofpedes || "0"}</span>
                  </div>
                  <div>
                    <span className="text-gray-500 dark:text-gray-400">Cyclists: </span>
                    <span className="text-gray-900 dark:text-white">{accident.cntofcycls || "0"}</span>
                  </div>
                </div>
              </div>
